...
class View:
    ...
    def drawVector(self, vec):
        ...
        vector2 = self.c.create_line([260,260], vec.getGUIVector2(), tag='second')
    ...
    def createGUI(self):
        ...
        Label(inputFrame, text="Rotate by").grid(row=0, column=4)
        Label(inputFrame, text="X1").grid(row=0,column=2)
        Label(inputFrame, text="Y1").grid(row=1,column=2)
